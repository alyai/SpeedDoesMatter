#pragma checksum "/Users/omega/Documents/GitHub/SpeedDoesMatter/SpeedDoesMatter/Views/Home/AboutPagespeed.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1835a70acbf84e78042f3e4080b0c62e39ef227d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1835a70acbf84e78042f3e4080b0c62e39ef227d", @"/Views/Home/AboutPagespeed.cshtml")]
...
<h2 id=""categories"" data-text=""Classifying Good, Needs Improvement, Poor"" tabindex=""0"">Classifying Good, Needs Impro");
            WriteLiteral(@"vement, Poor</h2>
<p>
...
<h3 id=""distribution"" data-text=""Distribution and selected metric values"" tabindex=""0"">Distribution and selected ");
            WriteLiteral(@"metric values</h3>
<p>
...
<p>
    <");
            WriteLiteral("img src=\"/speed/docs/insights/images/v5/blueribbon.svg\"");
...
<p>
    ...
    <a");
            WriteLiteral(@" href=""https://web.dev/fcp/"">
        First Contentful
        Paint
    </a>
    ,
...
<ul>
    <li>
        <b>Opportunities</b>
        provide suggestions how to improve the page’s perfo");
            WriteLiteral(@"rmance metrics.
...
<p>
    The field data is a historical report about ");
            WriteLiteral(@"how a particular URL has performed, and represents
...
<p>
    <b>
        Why does the FID");
            WriteLiteral(@" in v5 have different values?
    </b>
</p>
...
<p>
    ...
    <a target=""_blank"" rel=""noopener"" href=""https://developers.google.com/web/tools/chrome-user-experience-repor");
            WriteLiteral(@"t/#methodology"">opted-in users</a>
    and
...
<p>
    ...
    and have sufficient number of distinct samples that provide a representative, anonymi");
            WriteLiteral("zed view\n    of origin’s performance across all URLs that are visited on that origin.\n\n</p>");
        }
